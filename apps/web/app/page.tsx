...
export default function Home() {
  return (
    <main className="flex flex-1 flex-col items-center justify-center px-4 self-center">
      ...
      <div className="flex items-center gap-4 flex-col py-8">
